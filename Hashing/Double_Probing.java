...
public class Double_Probing {
    String[] hashTable;
    int noOfCellsUsedInHashTable;

    // Constructor
    Double_Probing(int size) {
    ...
    public static void main(String[] args) {
        Double_Probing doubleProbing = new Double_Probing(15);
        doubleProbing.insertKeyInHashTable("apple");
        doubleProbing.insertKeyInHashTable("mango");
        doubleProbing.insertKeyInHashTable("orange");
        doubleProbing.insertKeyInHashTable("apple");
        doubleProbing.insertKeyInHashTable("kiwi");
        doubleProbing.insertKeyInHashTable("mango");
        doubleProbing.displayHashTable();
