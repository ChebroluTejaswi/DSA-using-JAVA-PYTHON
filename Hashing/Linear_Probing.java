...
// Rehash
  ...
  {
      Linear_Probing linearProbing = new Linear_Probing(6);
      linearProbing.insertInHashTable("apple");
      linearProbing.insertInHashTable("mango");
      linearProbing.insertInHashTable("orange");
      linearProbing.insertInHashTable("apple");
      linearProbing.insertInHashTable("kiwi");
      linearProbing.deleteKeyHashTable("orange");
