...
public class Quadratic_Probing {
    ...
    public static void main(String[] args) {
        Quadratic_Probing quadraticProbing = new Quadratic_Probing(15);
        quadraticProbing.insertKeyInHashTable("apple");
        quadraticProbing.insertKeyInHashTable("mango");
        quadraticProbing.insertKeyInHashTable("orange");
        quadraticProbing.insertKeyInHashTable("apple");
        quadraticProbing.insertKeyInHashTable("kiwi");
        quadraticProbing.insertKeyInHashTable("mango");
